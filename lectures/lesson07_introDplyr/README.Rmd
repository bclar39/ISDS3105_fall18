...
```{r}
beerDt %>%
  mutate(LitersCapita = GallonsCapita * 3.78)
```
...
```{r}
titanicDt[titanicDt$Survived == 'No',] %>%
  group_by(Class) %>%
...
```{r}
beerDt$before_birthyear <- beerDt$Year < 1971
