...
ggplot(data = freqCasualties, aes(x = class, y = n, fill = gender, position=dodge)) + 
  geom_col()
...
ggplot(data = dt, labs(title = "College Students By Ethnicity", subtitle = "For Each College", caption = 'data from www.lsu.edu')) +
...
ggplot(data = dt) +
  geom_bar(aes(College, fill = Sex)) +
  scale_fill_brewer(palette = "BrBG", name = 'Gender')
...
ggplot(data = dt) +
  geom_bar(aes(College, fill = Sex)) +
  scale_fill_brewer(palette = "PuOr", name = "Gender") +
