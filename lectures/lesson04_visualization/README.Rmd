...
```{r, eval=FALSE}
ggplot() +
  geom_col(data =  twitter_users, aes(x = Year, y = millions, fill = Year ))
```
...
ggplot() +
  geom_col(data = freqCasualties, aes(x = paste(class, gender), y = n, fill = gender))

ggplot() +
  geom_col(data = freqCasualties, aes(x = class, y = n, fill = gender))

ggplot() +
  geom_col(data = freqCasualties, aes(x = class, y = n, fill = paste(class, gender)))
...
ggplot() +
  geom_line(data = twitter_users, aes(x = Year, y = millions), color = 'blue') +
  geom_point(data = twitter_users, aes(x = Year, y = millions)) + 
  geom_line(data = sn_users, aes(x = year, y = facebook), color = 'red') + 
  geom_point(data = sn_users, aes(x = year, y = facebook)) + 
  geom_line(data = sn_users, aes(x = year, y = twitter), color = 'purple')
...
ggplot() +
  ...
  geom_point(data = beerDt, aes(x = Year, y = GallonsCapita)) +
