...
if(!requireNamespace("RSocrata")) install.packages("RSocrata")
library(RSocrata)
library(here)
library(tidyverse)
...
if(!requireNamespace("digest")) install.packages("digest")
...
ggmap::register_google(key = 'AIzaSyBoSMQUV_3DKS6shGqQcFDZlpOx_GYR_nY')
